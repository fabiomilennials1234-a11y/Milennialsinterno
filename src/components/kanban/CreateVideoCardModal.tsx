...
interface CreateVideoCardModalProps {
  ...
  isLoading?: boolean;
  editorColumns: { id: string; title: string }[];
}

export default function CreateVideoCardModal({
  isOpen,
  onClose,
  onSubmit,
  isLoading = false,
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: Vídeo institucional cliente X"
            ...
            <div>
              ...
              <input
                type="url"
                value={formData.briefing.identity_url}
                onChange={e => setFormData(prev => ({ 
                  ...prev, 
                  briefing: { ...prev.briefing, identity_url: e.target.value }
                }))}
                placeholder="https://drive.google.com/..."
                className="input-apple"
              />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Detalhes importantes sobre a edição..."
                rows={3}
