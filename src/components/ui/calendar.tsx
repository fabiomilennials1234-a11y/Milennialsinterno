  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-primary/10 hover:text-foreground"),
        day_range_start: "day-range-start rounded-md",
        day_range_end: "day-range-end rounded-md",
        day_selected:
          "bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
        day_today: "ring-1 ring-inset ring-primary/60 text-foreground font-semibold aria-selected:ring-0",
        day_outside:
        ...
        day_disabled: "text-muted-foreground opacity-30 line-through decoration-muted-foreground/40",
        day_range_middle: "aria-selected:bg-primary/10 aria-selected:text-foreground aria-selected:rounded-none",
