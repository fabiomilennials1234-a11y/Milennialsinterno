...
/**
 * Coluna "Acompanhamento diário" (Seg-Sex) do Gestor de CRM.
 * Drag-and-drop entre dias exige documentação obrigatória
 * (mesma UX do Consultor de MKT Place).
 */
export default function CrmAcompanhamentoSection() {
  ...
  const validateForm = (): boolean => {
    if (docForm.falou_com_cliente === null) {
      toast.error('Informe se falou com o cliente hoje');
      return false;
    }
    if (docForm.falou_com_cliente === 'nao' && !docForm.falou_justificativa.trim()) {
  ...
  const handleDocSubmit = async () => {
    ...
    try {
      await saveDoc.mutateAsync({
        ...
        falou_com_cliente: docForm.falou_com_cliente || undefined,
          ...
          <div className="space-y-5 mt-2">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="sim" id="crm-falou-sim" />
                    <Label htmlFor="crm-falou-sim" className="text-sm">Sim</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="nao" id="crm-falou-nao" />
                    <Label htmlFor="crm-falou-nao" className="text-sm">Não</Label>
                  </div>
                </div>
              </RadioGroup>
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="sim" id="crm-fez-sim" />
                    <Label htmlFor="crm-fez-sim" className="text-sm">Sim</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="nao" id="crm-fez-nao" />
                    <Label htmlFor="crm-fez-nao" className="text-sm">Não</Label>
                  </div>
                </div>
              </RadioGroup>
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="sim" id="crm-comb-sim" />
                    <Label htmlFor="crm-comb-sim" className="text-sm">Sim</Label>
                  </div>
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="nao" id="crm-comb-nao" />
                    <Label htmlFor="crm-comb-nao" className="text-sm">Não</Label>
                  </div>
                </div>
              </RadioGroup>
