...
const PRO_TOOLS: ProTool[] = [
  ...
  { id: 'contas_millennials', title: 'Contas da Millennials', icon: '🏦', content: 'Conta de ADS: anapauladospassos53@gmail.com\n\nGmail Millennials: milennialswebservices@gmail.com\n\nAcesso Make\nLogin: leonardolestesul@hotmail.com\nSenha: Milennials151203._+' },
  { id: 'automacao_crm', title: 'Como fazer Automacao CRM dos Clientes', icon: '⚙️', content: 'Todos os treinamentos de automacao: https://drive.google.com/drive/folders/10fLqFUsYRsOQa5H9Rw7LD4nGQRfrXpHW?usp=sharing' },
  { id: 'acesso_cursos', title: 'Acesso Cursos', icon: '🎯', content: 'Como ver os cursos?: https://drive.google.com/file/d/17lWX-KZe8fW-m1UR-gNbP9ai7KLqqrgg/view?usp=sharing\n\nAcesso.\n\nLogin: fabiomilennials1234@gmail.com\n\nSenha: Milennials123' },
  { id: 'tabela_bonus', title: 'Tabela de Bonus Millennials', icon: '💰', content: 'TABELA GANHO DE BONUS MILENNIALS' },
];
