...
export default function OutboundNovoClienteSection() {
  const { data: clients = [], isLoading: clientsLoading, error: clientsError } = useOutboundAssignedClients();
    ...
    <>
      <div className="space-y-3">
        <div className="p-3 bg-muted/30 border border-border rounded-lg text-xs text-muted-foreground">
          <strong className="text-foreground">Nota:</strong> Clientes criados pelo Gestor de Projetos aparecem aqui. Complete as tarefas para avancar o onboarding.
        </div>
