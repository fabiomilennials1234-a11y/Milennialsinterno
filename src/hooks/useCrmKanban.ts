...
export const CRM_TASK_TITLE: Record<CrmProduto, Record<string, (name: string) => string>> = {
  v8: {
    criar_pipeline: (n) => `Criar Pipeline CRM ${n}`,
    conectar_whatsapp: (n) => `Configurar WhatsApp CRM ${n}`,
    conectar_meta: (n) => `Conectar Meta Ads CRM ${n}`,
    criar_campos: (n) => `Criar Campos CRM ${n}`,
    cadastrar_usuarios: (n) => `Cadastrar Usuários CRM ${n}`,
    importar_leads: (n) => `Importar Leads CRM ${n}`,
    testar_basico: (n) => `Testar CRM Básico ${n}`,
    finalizar: (n) => `Finalizar CRM V8 ${n}`,
  },
  automation: {
    criar_pipeline: (n) => `Criar Pipeline CRM ${n}`,
    conectar_whatsapp: (n) => `Configurar WhatsApp CRM ${n}`,
    ...
    importar_leads: (n) => `Importar Leads CRM ${n}`,
    testar_basico: (n) => `Testar CRM Básico ${n}`,
    criar_pipeline_auto: (n) => `Criar Pipeline Automação ${n}`,
    configurar_disparos: (n) => `Configurar Disparos WhatsApp ${n}`,
    automacao_entrada_lead: (n) => `Criar Automação Entrada Lead ${n}`,
    automacao_followup: (n) => `Criar Automação Follow-up ${n}`,
    automacao_reativacao: (n) => `Criar Automação Reativação ${n}`,
    testar_automacoes: (n) => `Testar Automações CRM ${n}`,
    finalizar: (n) => `Finalizar CRM Automation ${n}`,
  },
  copilot: {
    criar_pipeline: (n) => `Criar Pipeline CRM ${n}`,
    conectar_whatsapp: (n) => `Configurar WhatsApp CRM ${n}`,
    ...
    importar_leads: (n) => `Importar Leads CRM ${n}`,
    testar_basico: (n) => `Testar CRM Básico ${n}`,
    marcar_call: (n) => `Marcar Call Copilot ${n}`,
    definir_script_ia: (n) => `Definir Script IA Copilot ${n}`,
    configurar_ia: (n) => `Configurar IA Copilot ${n}`,
    configurar_agendamentos: (n) => `Configurar Agendamentos ${n}`,
    testar_ia: (n) => `Testar IA Copilot ${n}`,
    testar_agendamentos: (n) => `Testar Agendamentos ${n}`,
    finalizar: (n) => `Finalizar CRM Copilot ${n}`,
  },
};
