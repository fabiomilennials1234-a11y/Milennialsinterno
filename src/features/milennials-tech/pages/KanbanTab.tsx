    ...
    return (
      <>
        <div className="flex items-center justify-between mb-6">
          <div className="h-6 w-20 rounded bg-[var(--mtech-surface-elev)]" />
          <div className="h-8 w-28 rounded-md bg-[var(--mtech-surface-elev)]" />
        </div>
        <div className="flex gap-5">
          {[0, 1, 2, 3].map((col) => (
            <div key={col} className="flex-1 min-w-[260px] max-w-[340px]">
              <div className="h-4 w-16 rounded bg-[var(--mtech-surface-elev)] mb-4" />
              <div className="flex flex-col gap-2">
                {Array.from({ length: 3 - col % 2 }).map((_, i) => (
                  ...
                  >
                    <div className="h-3 w-14 rounded-full bg-[var(--mtech-surface-elev)]" />
                    <div className="h-4 w-3/4 rounded bg-[var(--mtech-surface-elev)]" />
                  </div>
                ))}
              </div>
            </div>
