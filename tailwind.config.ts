  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'title': ['1.125rem', { lineHeight: '1.75rem', letterSpacing: '-0.01em', fontWeight: '600' }],
      ...
      boxShadow: {
        'apple': '0 1px 3px 0 rgb(0 0 0 / 0.03), 0 1px 2px -1px rgb(0 0 0 / 0.03)',
        'apple-hover': '0 4px 6px -1px rgb(0 0 0 / 0.05), 0 2px 4px -2px rgb(0 0 0 / 0.03)',
        'apple-lg': '0 10px 15px -3px rgb(0 0 0 / 0.05), 0 4px 6px -4px rgb(0 0 0 / 0.03)',
        'kanban': '0 1px 2px 0 rgb(0 0 0 / 0.03)',
        'kanban-drag': '0 20px 40px -8px rgb(0 0 0 / 0.12)',
        'farol': '0 4px 12px -2px hsl(48 100% 50% / 0.3)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
