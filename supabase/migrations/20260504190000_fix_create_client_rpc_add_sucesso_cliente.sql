-- 20260504190000_fix_create_client_rpc_add_sucesso_cliente.sql
--
-- Adds 'sucesso_cliente' role to the permission check (PHASE 2) of
-- create_client_with_automations. Previously only executives, gestor_projetos,
-- and financeiro could call this RPC. Sucesso cliente users need to create
-- clients as part of their workflow.
--
-- Also consolidates the assigned_sucesso_cliente column support that was
-- previously applied via dynamic patching in 20260428050000.
...
BEGIN
  -- ==========================================================================
  -- PHASE 1 — Validacao de shape do payload (falha rapido)
  -- ==========================================================================
  ...
  -- ==========================================================================
  -- PHASE 4 — Inserts (tudo ou nada; rollback implicito em RAISE EXCEPTION)
  -- ==========================================================================
  ...
  -- 4.3 Automacoes do Gestor de Ads
...
COMMENT ON FUNCTION public.create_client_with_automations(jsonb, text) IS
  'Atomic client creation RPC. Replaces useCreateClient hook behind feature flag use_rpc_client_creation. Roles allowed: executive, gestor_projetos, financeiro, sucesso_cliente. Error codes: P0001 generic, P0002 invalid payload, P0003 unauthorized, P0004 cnpj duplicate, P0005 other unique, P0006 fk violation.';
